...
const Footer = () => {
  ...
  return <footer className="py-16 bg-luxury-pure border-t border-neon/20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-2xl font-heading text-gradient-accent mb-4">Rise Online</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Video Editing", "Social Media Management", "Social Media Content", "Thumbnails & Branding"].map(service => <li key={service}>
                  <a href="#services" className="text-muted-foreground hover:text-neon transition-colors duration-300 text-sm font-body">
                    {service}
                  </a>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:riseonlineediting@gmail.com" className="flex items-center gap-3 text-muted-foreground hover:text-neon transition-colors duration-300 text-sm font-body">
            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                <a key={index} href={href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-neon/30 rounded-lg
                             text-neon hover:bg-neon/10 hover:border-neon/60 transition-all duration-300">
        ...
        <div className="pt-8 border-t border-neon/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm font-body">
            © {currentYear} Rise Online. All rights reserved.
          </p>
          <p className="text-muted-foreground text-sm font-body">
            Crafted with <span className="text-neon">♦</span> for excellence
          </p>
        </div>
      </div>
    </footer>;
