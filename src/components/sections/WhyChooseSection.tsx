...
const WhyChooseSection = () => {
  return (
    <section id="why-choose" className="py-24 md:py-32 bg-luxury-black relative overflow-hidden">
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-neon/3 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-neon/5 rounded-full blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading">
              ...
              <span className="text-gradient-accent">Rise Online</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {reasons.map((reason, index) => (
              <div
                key={index}
                className="flex items-center gap-4 p-5 border border-neon/20 rounded-lg bg-card/50
                           hover:border-neon/40 hover:bg-card transition-all duration-300 group"
              >
                <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full 
                                border border-neon/40 bg-neon/10 group-hover:bg-neon/20 transition-colors duration-300">
